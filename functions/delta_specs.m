function [x,y,z,w,h,q,l,p,si_mixed,th,PCA_features]=delta_specs(si,timeasleep,print_hist,fs,f1,f2)
...
PCA_features=[];
    if ~isempty(si)
        ...
        %% Spectral entropy
        PCA_features(:,10)=cell2mat(cellfun(@(equis) spectral_entropy(equis,f1,f2,fs),si,'UniformOutput',false  ));
