...
clc
clear
cd /Users/pelinozsezer/Documents/Science/Radboud/CBD-Project/binned-data/detections_final_unfiltered
...
%% Ripples 
    ...
    % Depth 
    NREM_grouped_wave_forms = (detection_ratID214_HPCpyra_cbd(NREM_idx,:)); % event x time(sample*6s)
...
%     %% HPCbelo
%     NREM_grouped_wave_forms = (detection_ratID214_HPCbelo_cbd(NREM_idx,:)); % event x time(sample*6s)
%     singles_waveforms=(NREM_grouped_wave_forms(singles_idx_HPC,:)); % event x time(sample*6s)
% 
%     x = cell2mat(table2array(singles_grouped_oscil_table(:,2)));
%     ripple_idx_HPC=find(x==2);
...
%     end
%     
%     ripple_grouped_oscil_table_HPCbelo_ratID214          = ripple_grouped_oscil_table;
%     GC_ripple_waveforms_HPCbelo_ratID214                 = GC_ripple_waveforms;
% 
%     %% HPCabov
%     NREM_grouped_wave_forms = (detection_ratID214_HPCabov_cbd(NREM_idx,:)); % event x time(sample*6s)
%     singles_waveforms=(NREM_grouped_wave_forms(singles_idx_HPC,:)); % event x time(sample*6s)
% 
%     x = cell2mat(table2array(singles_grouped_oscil_table(:,2)));
%     ripple_idx_HPC=find(x==2);
...
%     end
%     
%     ripple_grouped_oscil_table_HPCabov_ratID214          = ripple_grouped_oscil_table;
%     GC_ripple_waveforms_HPCabov_ratID214                 = GC_ripple_waveforms;
...
%     GC_sw_waveforms_HPCbelo_ratID214                     = GC_sw_waveforms;
    ...
    sw_grouped_oscil_table_HPCpyra_ratID214              = sw_grouped_oscil_table;
    GC_sw_waveforms_HPCpyra_ratID214                     = GC_sw_waveforms;
...
%     end
%     
%     sw_grouped_oscil_table_HPCabov_ratID214              = sw_grouped_oscil_table;
%     GC_sw_waveforms_HPCabov_ratID214                     = GC_sw_waveforms;
...
%     end
% 
%     swr_HPCabov_idx_ratID214                             = swr_idx;
%     swr_grouped_oscil_table_HPCabov_ratID214             = swr_grouped_oscil_table;
%     GC_swr_waveforms_HPCabov_ratID214                    = GC_swr_waveforms;
...
%     end
% 
%     complex_swr_HPCabov_idx_ratID214                             = complex_swr_idx;
%     complex_swr_grouped_oscil_table_HPCabov_ratID214             = complex_swr_grouped_oscil_table;
%     GC_complex_swr_waveforms_HPCabov_ratID214                    = GC_complex_swr_waveforms;

%%
clearvars -except ripple_idx_HPC ripple_grouped_oscil_table_HPCpyra_ratID214 GC_ripple_waveforms_HPCpyra_ratID214...
    ripple_grouped_oscil_table_HPCbelo_ratID214 GC_ripple_waveforms_HPCbelo_ratID214...
    ripple_grouped_oscil_table_HPCabov_ratID214 GC_ripple_waveforms_HPCabov_ratID214...
    sw_idx sw_grouped_oscil_table_HPCbelo_ratID214 GC_sw_waveforms_HPCbelo_ratID214...
    sw_idx_HPC sw_grouped_oscil_table_HPCpyra_ratID214 GC_sw_waveforms_HPCpyra_ratID214...
    sw_idx_HPC sw_grouped_oscil_table_HPCabov_ratID214 GC_sw_waveforms_HPCabov_ratID214...
    ...
    swr_HPCabov_idx_ratID214 swr_grouped_oscil_table_HPCabov_ratID214 GC_swr_waveforms_HPCabov_ratID214... 
       ...
       complex_swr_HPCabov_idx_ratID214 complex_swr_grouped_oscil_table_HPCabov_ratID214 GC_complex_swr_waveforms_HPCabov_ratID214
